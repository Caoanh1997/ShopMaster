 ...
 * {@link DeleteOrderFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DeleteOrderFragment#newInstance} factory method to
...
public class DeleteOrderFragment extends Fragment {
     ...
     * @return A new instance of fragment DeleteOrderFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static DeleteOrderFragment newInstance(String param1, String param2) {
    ...
    private void Load() {
        ...
        firebaseDatabase.getReference("DeleteOrder").child(userID).addValueEventListener(new ValueEventListener() {
            @Override
